...
export default function acreditacionSaldo() {
	return (
		...
		<div className="App bg-white">
			...
			{componenteNavVar('Inicio', 'Acreditación de Saldo', 'Cerrar sesión')}
			...
			<div class="max-w-2xl mx-auto bg-white p-16">
				<form>
					...
					<div class="mb-6">
						<label for="email" class="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-1000">Saldo a acreditar total</label>
