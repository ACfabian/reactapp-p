...
import { Agregar } from '../Context/firestoreController'
...
export function Formregistro() {
  ...
  return (
    <div className="w-full max-w-lg m-auto text-black">
      <img
      ...
      <form  className="mt-5 space-y-6"  onSubmit={agg}>
        <div className="rounded-md shadow-sm -space-y-px">
          ...
          <input
            required
            type="text"
            onChange={(e) => setUser({ ...user1, nombre: e.target.value })}
        ...
        <div className="mb-4">
          ...
          <input
            required
            type="number"
            onChange={(e) => setUser({ ...user1, cedula: e.target.value })}
        ...
        <div className="mb-4">
          ...
          <input
            required
            type="tel"
            onChange={(e) => setUser({ ...user1, telefono: e.target.value })}
            //onChange={(e) => setUser({ ...user, password: e.target.value })}
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="mb-4">
          ...
          <input
           required type="radio"
           onChange={(e) => setUser({ ...user1, tipo: e.target.value })}
            name="tipocuenta" value="Cliente" 
           /> Cliente <br />

          <input required 
          onChange={(e) => setUser({ ...user1, tipo: e.target.value })}
          type="radio" name="tipocuenta" value="Propietario"/> Propietario        
        </div>
